...
Among the COVID outbreak, we all trying to cook some yummy food at home. This recipe is a result of such an adventure. 
...
* The next step is to make a puree for which you will need a hand blender/ a mixer jar. Grind to make a fine paste and keep it in a separate container.

!!! warn ""
    Please be careful as the masala you made is hot. You can add some water before blending it. I used a hand blender.
